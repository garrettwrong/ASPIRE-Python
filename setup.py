...
setup(
    ...
    extras_require={
        "gpu_102": ["pycuda", "pynufft", "reikna", "cupy-cuda102", "cufinufft==1.2"],
        "gpu_110": ["pycuda", "pynufft", "reikna", "cupy-cuda110", "cufinufft==1.2"],
        "gpu_111": ["pycuda", "pynufft", "reikna", "cupy-cuda111", "cufinufft==1.2"],
        "gpu_11x": ["pycuda", "pynufft", "reikna", "cupy-cuda11x", "cufinufft==1.2"],
        "dev": [
            "black",
            "bumpversion",
            "check-manifest",
